    ...
    public partial class Actors : Form
    {
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "UPDATE Actor SET first_name=@FirstName, last_name=@LastName WHERE first_name=@OldFirstName AND last_name=@OldLastName";
                SqlCommand cmd = new SqlCommand(query, con);
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "DELETE FROM Actor WHERE first_name=@FirstName AND last_name=@LastName";
                SqlCommand cmd = new SqlCommand(query, con);
